...
callservice() {
  ...
  do
    ...
    ####################################
    output=`curl -H "Content-Type: application/json" -X POST -d  $json https://6gp82n6dt1.execute-api.us-east-1.amazonaws.com/mycpu 2>/dev/null`
    #output=`curl -H "Content-Type: application/json" -X POST -d  $json https://u0blz1vrvg.execute-api.us-east-1.amazonaws.com/mycpu2 2>/dev/null`
